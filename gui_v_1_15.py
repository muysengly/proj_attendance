...
# Form implementation generated from reading ui file 'gui_v_1_15.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_camera.setGeometry(QtCore.QRect(13, 176, 640, 480))
        self.label_camera.setFrameShape(QtWidgets.QFrame.Box)
        self.label_camera.setText("")
        self.label_camera.setObjectName("label_camera")
        self.pushButton_save = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_save.setGeometry(QtCore.QRect(880, 670, 200, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton_save.setFont(font)
        self.pushButton_save.setObjectName("pushButton_save")
        self.listView_attd = QtWidgets.QListView(self.centralwidget)
        self.listView_attd.setGeometry(QtCore.QRect(880, 215, 200, 441))
        font = QtGui.QFont()
        ...
        self.listView_init.setGeometry(QtCore.QRect(660, 215, 200, 441))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pushButton_reset.setGeometry(QtCore.QRect(660, 670, 200, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.pushButton_reset.setFont(font)
        self.pushButton_reset.setObjectName("pushButton_reset")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(880, 176, 200, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_6.setGeometry(QtCore.QRect(13, 686, 250, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.label_9.setGeometry(QtCore.QRect(10, 710, 301, 30))
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.comboBox_camera.setGeometry(QtCore.QRect(500, 670, 150, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.comboBox_group.setGeometry(QtCore.QRect(660, 176, 200, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
